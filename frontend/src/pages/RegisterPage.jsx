    ...
    <div className="w-full max-w-md bg-[#161b22] border border-[#30363d]
      ...
      <div className="flex flex-col items-center gap-3 mb-8">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-semibold text-[#e6edf3]">Create account</h1>
          <p className="text-[#8b949e] text-sm mt-1">Join NeuroChat today</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-[#0d1117] border border-[#30363d] rounded-lg px-4 py-3 text-sm
                       ...
                       focus:border-[#2f3332] focus:ring-2 focus:ring-[#10a37f]/20 transition-all"
          />
        </div>
        ...
        {/* Confirm Password */}
        <div>
          <label className="block text-xs font-medium text-[#8b949e] mb-1.5">Confirm Password</label>
          <input
            id="register-confirm"
            type="password"
            name="confirm"
      ...
      <p className="text-center text-sm text-[#6e7681] mt-6">
        ...
        <Link to="/login" className="text-[#e3e8e7] hover:underline font-medium transition-colors">
          Sign in
        </Link>
      </p>
    </div>
